          ...
          <div className="grid gap-6 xl:grid-cols-[240px_minmax(0,1fr)_250px]">
            <aside className="space-y-4">
              ...
              {suggestions.map((item) => (
                ...
                >
                  <div className={`relative min-h-[160px] bg-gradient-to-br ${item.accent} p-4 text-white`}>
                    <div
                    ...
                    <div className="relative flex h-full flex-col justify-between mt-3">
                      <div>
                        ...
                        <p className="text-sm italic text-white/85">{item.tagline}</p>
                      </div>
                      <div className="flex items-end justify-between gap-3">
                        <p className="max-w-[140px] text-sm text-white/90">{item.address}</p>
...
>
  Book Now
    ...
    setSelectedStaffForBooking(null);}} className="cursor-pointer">View All</span>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <h2 className="text-3xl font-bold text-slate-900">Our Staffs</h2>
                  <Button variant="link" asChild className="px-0 text-blue-600 cursor-pointer"
            ...
            <aside className="space-y-4">
              <Card className="rounded-[28px] border-slate-200 shadow-sm bg-white">
                <CardContent className="space-y-5 p-5">
                  ...
                  onClick={() => {setBookingModalOpen(true); setSelectedServiceForBooking(null); setSelectedStaffForBooking(null);}}
                  >
                    Select Service
                  </Button>
                </CardContent>
