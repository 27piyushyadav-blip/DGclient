...
export default function ProfileModal({ open, onOpenChange, staff, venueName = "" }: ProfileModalProps) {
  ...
  const displayedReviews = showAllReviews ? staffData.reviewsList : staffData.reviewsList.slice(0, 2);
