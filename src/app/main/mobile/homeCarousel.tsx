...
export default function homeCarousel({
  ...
  return (
    <>
      <Card className="overflow-hidden rounded-none border-1 shadow-none rounded-2xl">
      <div className="bg-gray-100 rounded-md">
        <div className="rounded-md relative flex flex-col min-h-[75px] bg-slate-900 text-white">
          <div
            key={currentIndex}
          ...
          <div className="absolute right-3 top-19 cursor-pointer z-20">
          ...
          {totalSlides > 1 && (
            <>
              <button
                onClick={goPrev}
                className="absolute left-0.5 top-19 flex h-5 w-5 -translate-y-1/2 items-center justify-center rounded-full bg-white/20 text-white backdrop-blur-md transition hover:bg-white/40 z-20"
              ...
              <button
                onClick={goNext}
                className="absolute right-0.5 top-19 flex h-5 w-5 -translate-y-1/2 items-center justify-center rounded-full bg-white/20 text-white backdrop-blur-md transition hover:bg-white/40 z-20"
        ...
        <div className="relative flex flex-1 flex-col justify-between z-10 pb-1">  
            ...
            <div className="px-2 mt-1">
              <div className="grid grid-cols-1 gap-1.5  z-10">
                <h1 className="text-[10px] font-bold tracking-tight leading-tight flex  items-left gap-1 ml-5">
                {activeVenue?.name}
              </h1>
                <div className="flex items-center gap-1.5 text-xs font-medium text-white/90 z-10 ml-5">
                <MapPin className="h-3 w-3 text-blue-400" />
                <span className="truncate max-w-[200px] text-[7px] text-black ">{activeVenue?.address}</span>
              </div>
              </div>
              <div className="flex justify-between gap-1.5 mb-0 z-20">
